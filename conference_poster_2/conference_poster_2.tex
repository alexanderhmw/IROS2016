...
\author{Mengwen He$^{1^*,3^*,5}$, Eijiro Takeuchi$^{1,3}$, Yoshiki Ninomiy$^{2,3}$, and Shinpei Kato$^{3,4}$} % Author(s)
...
\institute{$^1$Graduate School of Information Science, Nagoya University (* left since April, 2016)\\
	...
	$^5$Department of Electrical and Computer Engineering, Carnegie Mellon University} % Institution(s)
...
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{./img/accident}
